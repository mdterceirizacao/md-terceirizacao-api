...
// --------------------------------------
// CONFIGURAÇÃO CORRETA PARA GMAIL + APP PASSWORD
// --------------------------------------
const transporter = nodemailer.createTransport({
  host: "smtp.gmail.com",
  port: 465,
  secure: true, // Gmail exige SSL na porta 465
  auth: {
    user: process.env.EMAIL_USER, // seu email completo
    pass: process.env.EMAIL_PASS  // senha de app (16 caracteres)
  },
  tls: {
    rejectUnauthorized: false // ← IGNORA certificado interceptado
  }
})
// --------------------------------------
              ...
              <div style="font-family: Arial, sans-serif; background-color:#f5f5f5; padding:30px;">
                ...
                ">
                  ...
                  <div style="padding:25px 30px; color:#111827;">
                    ...
                    <h2 style="font-size:20px; margin-bottom:15px; color:#1f2937;">
                    ...
                    <div style="margin-top:35px; text-align:center; color:#6b7280; font-size:13px;">
                      ...
                      <p style="margin:0;">
                        ...
                        <strong>MD Terceirização</strong>.
                      </p>
            ...
            <div style="font-family: Arial, sans-serif; background-color:#f5f5f5; padding:30px;">
              ...
              ">
                ...
                ">
                  ...
                  <p style="margin:0; margin-top:6px; font-size:14px; color:#fef3c7;">
                    Um candidato enviou um currículo através do site.
                  </p>
                </div>
                ...
                <div style="padding:25px 30px; color:#111827;">
                  ...
                  <div style="
                    ...
                    line-height:1.6;
                  ">
                    O currículo em PDF foi anexado a este e-mail.  
                    <br><br>
